...
>>>>>>> 2bf5646cd19980bdd56d23ba888a232158861ae5
</head>
<body>
	<% 
	...
	<main class="main_menu">
		<header class="sub-header">
			<ul class="sub-header_container">
				...
				%>
				<li class="categories_item"><a href="#<%=item.getName()%>"><%=item.getName()%></a>
				</li>
				<% } %>
			</ul>
		</header>
		<section class="menu_header">
			<button class="search_open-btn">
			...
			<div class="menu_grid" id="menu_grid_<%=item.getCategory()%>">
				...
				<div class="menu_item">
					<div class="menu_content">
						...
						<% } %>
						<div class="menu_price"><%=item.getPrice()%>$
						</div>
					</div>
					<div class="menu_img">
